...
export default function PlanClient() {
  ...
  // (Optional) catalog rows if you want display name/video later; for now keep minimal
  const [catalogRows, setCatalogRows] = useState<Record<string, ExerciseCatalogRow | null>>({});
